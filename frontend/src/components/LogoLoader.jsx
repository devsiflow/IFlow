        ...
        {`
          ...
          @keyframes logo-futuristic {
            ...
            25% {
              ...
              filter: drop-shadow(0 0 12px #4ade80) drop-shadow(0 0 30px #22c55e);
            }
            50% {
              transform: perspective(800px) rotateY(0deg) scale(1.1);
              filter: drop-shadow(0 0 16px #22c55e) drop-shadow(0 0 40px #86efac);
            }
            75% {
              transform: perspective(800px) rotateY(-10deg) scale(1.05);
              filter: drop-shadow(0 0 12px #4ade80) drop-shadow(0 0 30px #22c55e);
          ...
          .animate-logo-futuristic {
            animation: logo-futuristic 3s ease-in-out infinite;
          }
          ...
          .meteor-1 {
            top: 10%;
            left: -20%;
            animation: meteor-move 1.5s linear infinite;
            animation-delay: 0s;
          }
          .meteor-2 {
            top: 40%;
          ...
          .meteor-4 {
            top: 20%;
            left: -15%;
            animation: meteor-move 1.6s linear infinite;
