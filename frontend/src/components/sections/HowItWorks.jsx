...
function HowItWorks() {
  return (
    <section
      id="comoFunciona"
      data-aos="fade-up"
      className="relative group px-6 py-20 text-center bg-gradient-to-br from-white via-slate-50 to-emerald-50 overflow-hidden"
    >
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-16">
        ...
        <div className="transition-transform duration-300 group-hover:scale-[1.02]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-md px-6 py-4 rounded-xl shadow-md border border-emerald-100">
              <Search className="w-12 h-12 text-emerald-600" />
              <p className="mt-2 text-sm text-gray-700">Procure no catálogo</p>
            </div>
            <ArrowRight className="hidden md:block w-6 h-6 text-gray-400" />
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-md px-6 py-4 rounded-xl shadow-md border border-emerald-100">
              <ClipboardList className="w-12 h-12 text-emerald-600" />
              <p className="mt-2 text-sm text-gray-700">Veja os achados</p>
            </div>
            <ArrowRight className="hidden md:block w-6 h-6 text-gray-400" />
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-md px-6 py-4 rounded-xl shadow-md border border-emerald-100">
              <Send className="w-12 h-12 text-emerald-600" />
              <p className="mt-2 text-sm text-gray-700">Solicite a devolução</p>
            </div>
          </div>
        </div>
        ...
        <div className="transition-transform duration-300 group-hover:scale-[1.02]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-md px-6 py-4 rounded-xl shadow-md border border-emerald-100">
              <PackagePlus className="w-12 h-12 text-emerald-600" />
              <p className="mt-2 text-sm text-gray-700">Cadastre no sistema</p>
            </div>
            <ArrowRight className="hidden md:block w-6 h-6 text-gray-400" />
            <div className="flex flex-col items-center bg-white/80 backdrop-blur-md px-6 py-4 rounded-xl shadow-md border border-emerald-100">
              <ClipboardList className="w-12 h-12 text-emerald-600" />
              <p className="mt-2 text-sm text-gray-700">Disponível no catálogo</p>
            </div>
          </div>
        </div>
      </div>
